...
SceneHighScore *SceneHighScore::cantTouchMain = new SceneHighScore(SceneManager::GetInstance());

SceneHighScore::SceneHighScore(SceneManager *zeSceneManager)
{
	Scene_name_ = "HighScore";
...
void SceneHighScore::Init()
{
	...
	highscore = Create::Entity("HIGHSCORE_TITLE", Vector3(startX, startY, 0.f), Vector3(gameWidth*0.02 * (800 / 199), gameWidth*0.02, 5));
	m_activeList.push_back(highscore);
