...
void GraphicsManager::SetPerspectiveProjection(double _fovy, double _aspect, double _zNear, double _zFar)
{
	projectionMatrix.SetToPerspective(_fovy, _aspect, _zNear, _zFar);
}
